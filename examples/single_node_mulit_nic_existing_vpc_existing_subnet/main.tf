locals {
  ...
  custom_tags           = {
    ...
    f5xc-template = "f5xc_aws_cloud_ce_single_node_single_nic_existing_vpc_existing_subnet"
  }
}

module "f5xc_aws_cloud_ce_single_node_single_nic_existing_vpc_existing_subnet" {
...
output "f5xc_aws_cloud_ce_single_node_single_nic_existing_vpc_existing_subnet" {
  value = module.f5xc_aws_cloud_ce_single_node_single_nic_existing_vpc_existing_subnet
}