locals {
  ...
  custom_tags           = {
    ...
    f5xc-template = "f5xc_aws_cloud_ce_single_node_multi_nic_new_vpc_new_subnet"
  }
}
...
/*output "f5xc_aws_cloud_ce_single_node_multi_nic_new_vpc_new_subnet" {
  value = module.f5xc_aws_cloud_ce_single_node_multi_nic_new_vpc_new_subnet
}*/