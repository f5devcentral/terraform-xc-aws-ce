locals {
  ...
  aws_availability_zone_node1 = format("%s%s", var.f5xc_aws_region, var.f5xc_aws_availability_zone_node1)
  aws_availability_zone_node2 = format("%s%s", var.f5xc_aws_region, var.f5xc_aws_availability_zone_node2)
  custom_tags                 = {
    Owner         = var.owner
    f5xc-tenant   = var.f5xc_tenant
    f5xc-template = "f5xc_aws_cloud_ce_three_node_multi_nic_existing_vpc_new_subnet"
  }
}

module "f5xc_aws_cloud_ce_three_node_multi_nic_existing_vpc_new_subnet" {
...
output "f5xc_aws_cloud_ce_three_node_multi_nic_existing_vpc_new_subnet" {
  value = module.f5xc_aws_cloud_ce_three_node_multi_nic_existing_vpc_new_subnet
}