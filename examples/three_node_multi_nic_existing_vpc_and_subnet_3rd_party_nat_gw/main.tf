locals {
  ...
  custom_tags = {
    ...
    f5xc-template = "f5xc_aws_cloud_ce_three_node_multi_nic_existing_vpc_new_subnet_slo_no_eip_3rd_party_nat_gw"
  }
}

module "f5xc_aws_cloud_ce_three_node_multi_nic_existing_vpc_new_subnet_slo_no_eip_3rd_party_nat_gw" {
  ...
  f5xc_aws_vpc_az_nodes = {
    ...
    node1 = {
      ...
      aws_existing_sli_subnet_id = var.aws_sli_subnet_id_node1
      aws_vpc_az_name            = local.aws_availability_zone_node1
    }
    node2 = {
      aws_existing_slo_subnet_id = var.aws_slo_subnet_id_node2
      aws_existing_sli_subnet_id = var.aws_sli_subnet_id_node2
...
output "f5xc_aws_cloud_ce_three_node_multi_nic_existing_vpc_new_subnet_slo_no_eip_3rd_party_nat_gw" {
  value = module.f5xc_aws_cloud_ce_three_node_multi_nic_existing_vpc_new_subnet_slo_no_eip_3rd_party_nat_gw
}